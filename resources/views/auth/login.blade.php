...
<body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>تنافس</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">ياهلا والله .. حياك في تنافس .. نظام بسيط وسهل لرصد الدرجات :)</p>
...
<p class="mb-0">
    <a href="{{ route('register') }}" class="text-center">تسجيل جديد</a>
</p>
</div>
<!-- /.login-card-body -->
</div>
